...
class MyFunc():
    ...
    def __init__(self):
        ...
        def minimaxgame(z,board_contest,label):
            ...
            if(z==0):
                new_estimater,pieces_of_black,pieces_of_white = MorrisAlgo.Static_estimate_for_whiteopening_updated1(board_contest)
                ...
                if(pieces_of_black<=2):
                    ...
                    exit.head = (1000*(new_estimater) - len(MorrisAlgo.GenerateMovesMidGameEndGameBlack(board_contest)))
                exit.counter +=1
                return exit
        ...
        def display(): 
            exit = minimaxgame(depth,read_board(),1)
