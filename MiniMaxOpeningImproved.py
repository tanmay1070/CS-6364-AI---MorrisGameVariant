...
class MyFunc():
    ...
    def __init__(self):
        ...
        def minimax_opening(z,board_contest,label):
            ...
            if(z==0):
                counter_last = MorrisAlgo.Static_estimate_for_whiteopening_updated(board_contest);exit = MorrisAlgo.main(counter_last,exit.counter+1,board_contest);return exit
        ...
        def display(): 
            exit = minimax_opening(depth,read_board(),1)
